...
This repository composes the training and experiment repositories as Git submodules under `src/`.

## Submodules

| Path | Repository | Branch |
| --- | --- | --- |
| `src/DRL_training` | <https://github.com/IROL-SSU/High_level_task_planner--DRL-sim-data_train_eval.git> | `master` |
| `src/DRL_experiment` | <https://github.com/7cmdehdrb/DRL-Occluded-Object-Search.git> | `revision` |
